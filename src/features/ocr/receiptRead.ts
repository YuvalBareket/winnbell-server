...
const PROMPT = [
  ...
  '3. identifier_candidates: every number or code printed on it that identifies THIS',
  '   transaction - check/order/transaction/receipt/invoice/ticket/reference numbers and',
  '   POS-assigned ids (e.g. a Clover ID, Square receipt code, Toast check number) - each',
  '   exactly as printed with its printed label. Exclude phone numbers, addresses, and',
  '   loyalty/rewards codes.',
